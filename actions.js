...
var memory_array = ['Melkmeisje','Melkmeisje','Johannes Vermeer','Johannes Vermeer','Rembrandt','Rembrandt','Nachtwacht','Nachtwacht','De Molen','De Molen','Jacob van Ruisdael','Jacob van Ruisdael','De Joodse Bruid','De Joodse Bruid','Het Straatje','Het Straatje','Het Vrolijke Huisgezin','Het Vrolijke Huisgezin'];
var memory_values = [];
var memory_tile_ids = [];
var tiles_flipped = 0;
